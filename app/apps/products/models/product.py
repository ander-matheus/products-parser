...
class Product(models.Model):
    ...
    categories = models.TextField(max_length=255, blank=True, null=True)
    labels = models.TextField(max_length=255, blank=True, null=True)
    ...
    serving_size = models.TextField(max_length=255, blank=True, null=True)
    ...
    main_category = models.TextField(max_length=255, blank=True, null=True)
